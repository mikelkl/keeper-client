<template>
  <div id="scroll" @scroll="scrollHandler" class="layout mdl-layout mdl-js-layout mdl-color--grey-100">
    <div class="ribbon">
      <header class="mdl-grid header-anim">
        ...
        <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-color--black mdl-color-text--white">登陆</button>
      </header>
      <div class="intro mdl-cell--6-col mdl-cell--1-offset">
    ...
    <main class="main mdl-layout__content">
      <div class="services mdl-grid">
        <div class="intro mdl-cell--3-col mdl-grid animate1" id="intro1">
        ...
        <div class="mdl-cell--8-col mdl-grid detail">
          <div class="intro mdl-cell--6-col" id="device1">
          ...
          <div class="intro mdl-cell--6-col" id="device2">
            <svg class="icon" width="200" height="200" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
                <style type="text/css">
                  <![CDATA[ @font-face {
          ...
          <div class="intro mdl-cell--6-col" id="device3">
            <svg class="icon" width="200" height="200" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
                <style type="text/css">
                  <![CDATA[ @font-face {
          ...
          <div class="intro mdl-cell--6-col" id="device4">
            <svg class="icon" width="200" height="200" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
                <style type="text/css">
                  <![CDATA[ @font-face {
      ...
      <div class="current mdl-grid">
        ...
        <div class="mdl-cell--4-col">
          <svg width="480" height="560" viewbox="0 0 480 560">
            ...
            <!-- <circle id="circle1" cx="240" cy="240" r="130" stroke-width="20" stroke="#00A5E0" fill="none" transform="matrix(0,-1,1,0,0,480)" stroke-dasharray="244.92 817"></circle> -->
        ...
        <div class="mdl-cell--4-col">
          <svg width="480" height="560" viewbox="0 0 480 560">
            ...
            <!-- <circle cx="240" cy="240" r="130" stroke-width="20" stroke="#00A5E0" fill="none" transform="matrix(0,-1,1,0,0,480)" stroke-dasharray="171.444 817"></circle> -->
        ...
        <div class="mdl-cell--4-col">
          <svg width="480" height="560" viewbox="0 0 480 560">
            ...
            <!-- <circle id="circle3" cx="240" cy="240" r="130" stroke-width="20" stroke="#00A5E0" fill="none" transform="matrix(0,-1,1,0,0,480)" stroke-dasharray="546.988 817"></circle> -->
...
<script>
  export default {
    ...
    methods: {
      login () {
        // this.$http.post('http://localhost:5000/api/v1.0/login/', {
      ...
      scrollHandler (event) {
        ...
        } else if (scrollBottom >= (ribbonHeight + servicesHeight + 20) && scrollBottom < (ribbonHeight + servicesHeight + currentHeight)) {
          setTimeout(function () {
            svgs[4].classList.add('vertical-anim')
          }, 100)
          setTimeout(function () {
            svgs[5].classList.add('vertical-anim')
          }, 200)
          setTimeout(function () {
            svgs[6].classList.add('vertical-anim')
          }, 300)
          setTimeout(function () {
...
@keyframes vertical {
  ...
  .services {
    padding-bottom: 10vh;
    background: url('../assets/images/pic2.jpg') center fixed;
    background-size: cover;
  }

  .current {
    padding-bottom: 10vh;
    background: url('../assets/images/pic3.jpg') center fixed;
    background-size: cover;
    text-align: center;
  }
